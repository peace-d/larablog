    ...
    <div class="row">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-pills nav-pills-soft flex-column fw-bold gap-2 border-0">
                                    <li class="nav-item" data-bs-dismiss="offcanvas">
                                        <a class="nav-link d-flex mb-0 active" href="#nav-profile" data-bs-toggle="tab"><span>Account </span></a>
                                    </li>

                                    <li class="nav-item" data-bs-dismiss="offcanvas">
                                        <a class="nav-link d-flex mb-0" href="#nav-setting-tab-6" data-bs-toggle="tab"><span>Close account </span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="col-lg-6 vstack gap-4">
            <div class="tab-content py-0 mb-0">
                <div class="tab-pane show active fade" id="nav-nav-profile">
                    <div class="card mb-4">
                        <div class="card-header border-0 pb-0">
                            <h1 class="h5 card-title">Profile</h1>
                        </div>
                        <div class="card-body">
...
{{--                            @endif--}}
                            ...
                            <form class="row g-3" method="POST" action="{{ route('app_update_user') }}">
                                @csrf
                                <input type="hidden" name="id" value="{{ Auth::user()->id }}">
                                <div class="col-sm-6">
                                    <label class="form-label">First name</label>
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" placeholder="" name="first_name" value="{{ $user->first_name }}">
                                    @error('first_name')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('last_name') is-invalid @enderror" placeholder="" name="last_name" value="{{ $user->last_name }}">
                                    @error('last_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('display_name') is-invalid @enderror" placeholder="" name="display_name" value="{{ $user->display_name }}">
                                    @error('display_name')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('occupation') is-invalid @enderror" placeholder="" name="occupation" value="{{ $user->occupation }}">
                                    @error('occupation')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('contact_number') is-invalid @enderror" placeholder="" name="contact_number" value="{{ $user->contact_number }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="" name="email" value="{{ $user->email }}">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('bio') is-invalid @enderror" rows="4" name="bio" placeholder="Bio">{{ $user->bio }}</textarea>
                                    @error('bio')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                ...
                <div class="tab-pane fade" id="nav-setting-tab-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pb-0">
                            ...
                            <p class="mb-0">Tried law yet style child. The bore of true of no be deal. Frequently sufficient to
                                be unaffected. The furnished she concluded depending procuring concealed. </p>
                        </div>
                        <!-- Card header START -->
                        <!-- Card body START -->
                        <div class="card-body pb-0">
                            ...
                            <ul class="list-group list-group-flush">
                                                ...
                                                <a href="#!"
                                                   ...
                                                   aria-expanded="false" aria-controls="flush-collapseOne">
                                                    <span>
                                                        ...
                                                        <small class="small mb-0 text-secondary">As hastened oh produced
                                                            prospect. </small>
                                                    </span>
                                                </a>
                                            </h2>
                                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body p-0 pt-3">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <!-- Notification list item -->
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="NotiRadio"
                                                                   id="NotiRadio1">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                                    <div class="me-2">
                                        <h6 class="mb-0">Weekly account summary <span class="badge bg-primary smaller"> Pro
                                                only</span> </h6>
                                        <p class="small mb-0">Rendered six say his striking confined. </p>
                                    </div>
                                    <div class="form-check form-switch">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-md-flex justify-content-between align-items-start">
                                    <div class="me-md-3">
                                        ...
                                        <p class="small mb-0">Unaffected occasional thoroughly. Adieus it no wonders spirit
                                            houses. </p>
                                    </div>
                                ...
                                <div class="accordion-item bg-transparent">
                                    ...
                                    <div id="communicationcollapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <!-- Notification list item -->
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="ComRadio" id="ComRadio2"
                                                       checked="">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <p class="small">Your personal information is safe with our marketing
                                                            partners unless you respond to their Sponsored Messages </p>
                                                    </div>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
